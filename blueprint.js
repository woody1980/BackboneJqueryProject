...
/* ==========================================================================
 Calendar Refactor
 ========================================================================== */
//10.5 - eliminate build days function
//Build class
...
function buildDays() {
  //list number of days
  var t =  cal[curr_mo].days;
  var r =  cal[curr_mo].month;
  var bl = cal[curr_mo].blank_days;
  var cd = cal[curr_mo].current;
  var l;
  ...
  //Build number days
      function buildDays(){
          for (l=1; l<t; l++) {
              var showDay ='<td class="'+ 'd_'+ l + ' daySpan">' +  '<span class="date">' + l + '</span>'+ '<span class="curr_day no_visi">&#8226;</span>' + '</td>';
  ...
  //Show the current day
      function buildCurrentDay(){
          $('td.daySpan span').each(function() {
              if ( $(this).text() == curr_day && cd == static_mo) {
...
function createChartNext() {

  if ( $('div#ical').length >  0) {
